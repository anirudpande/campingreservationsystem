<?php
	...
	if ($_SERVER ['REQUEST_METHOD']	== 'POST')
	{
		...
		if ($state != '' && $city != '' && $name != '')
		{
			$DB_SQL		= 'SELECT NAME,STREET,CITY,STATES,IMAGE_PATH,MAX_SLOTS,FEATURES, GEOGRAPHY, RECREATION, FACILITIES, PRICE FROM camping_site c, description d WHERE c.desc_id = d.desc_id AND c.STATES= "' .  $state . '" AND c.NAME= "' . $name . '" AND c.CITY="' . $city.'"';
